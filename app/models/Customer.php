...
class Customer extends \Eloquent {
	...
	protected $fillable = array('last_name', 'first_name', 'gender', 'status', 'del_contact_number', 'del_address_number', 'del_address_baranggay', 'del_address_municipal', 'del_address_province');
