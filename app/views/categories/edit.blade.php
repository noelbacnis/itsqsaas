...
@section('content2')
    ...
    <div class="row">
       	<div class="col-lg-12">
            <h1 class="page-header"> Edit a Category </h1>
            <ol class="breadcrumb">
                ...
                <li> <i class="fa fa-dashboard"></i>  <a href="{{ action('categories.index') }}">Categories</a> </li>
               	<li class="active"> <i class="fa fa-table"></i> Edit a Category </li>
            </ol>
        </div>
    </div>
    <!-- /.row -->
	...
	<div class="row">
		<div class="col-md-12">
			{{ Form::model($category, array('method' => 'PATCH', 'class' => 'form-horizontal', 'route' => array('categories.update', $category->id))) }}
