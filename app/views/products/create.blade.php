       	...
       	<div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li> <i class="fa fa-dashboard"></i>  <a href="{{ action('products.index') }}">Products</a> </li>
               	<li class="active"> <i class="fa fa-table"></i> Add a Product </li>
            </ol>
        </div>
    </div>
    <!-- /.row -->
		        ...
		        <div class="panel-body" style="padding:50px 100px 15px 100px;">
		            ...
		            <div class="col-md-8">
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="col-sm-9">
		                        {{ Form::select('category_id', $categories, $value=null, array('class'=>'form-control')) }}
		                    </div>
		                </div>
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="col-sm-9">
		                        {{ Form::select('status', $status, $value=null, array('class'=>'form-control')) }}
		                    </div>
		                </div>
